...
* https://churreriadexalapa.com

## Preguntas de arranque
* ¿Cuál es el objetivo del sitio web?
* ¿Cuál es el público objetivo?
* ¿Qué se puede hacer en tu sitio? (se vale soñar...)
* ¿Qué no te gustaría?

## Contenido para categorizar secciones
* Instalaciones.
* Propósito/Why/Razón de ser.
* Menú digital.

## Pie de página
* RRSS (redes sociales activas).
* Medios de contacto.
* Dirección (¿inlcuir mapa de ubicación?).
